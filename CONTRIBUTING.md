...
These are some global design goals in bitcore-desire to which any change should adhere.
...
```sh
git remote add desire git@github.com:lazyboozer/bitcore-desire.git
git pull --rebase desire master
```
...
```
Finally go to [github.com/lazyboozer/bitcore-desire](https://github.com/lazyboozer/bitcore-desire) in your web browser and issue a new pull request.
...
[github.com/lazyboozer/bitcore-desire/issues](https://github.com/lazyboozer/bitcore-desire/issues).
